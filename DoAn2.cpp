...
void GiaoDienDSVatTu(TREE_VATTU &ds_vt,DS_NV ds){
	...
	while (true){
		...
		if(i>28){
			...
			else if(y>6 && y<33 && dem>0 && dem<i-1){
				if (c==72){ //Up
					y--;
					dem--;
					gotoxy(x,y);
...
void GiaoDienMenuQuanLyNhanVien(){
	...
	cout<<"Esc: Quay lai";
	gotoxy(55,44);
	cout<<"Enter: Xem hoa don theo ngay thang";
}
